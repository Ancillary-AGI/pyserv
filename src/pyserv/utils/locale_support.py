"""
Locale support utilities for Pyserv 
...
class LocaleManager:
    ...
    def __init__(self, default_locale: str = 'en_US', domain: str = 'pyserv '):
...
class TranslationManager:
    ...
    def compile_translations(self, locale_code: str, domain: str = 'pyserv ') -> None:
